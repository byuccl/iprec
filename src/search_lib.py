    ...
    while 1:
        ...
        while 1:
            ...
            (
                ...
                descend_pass_flag,
                dec_list,
            ) = descend(g, g_template, mapping, None)
        ...
        if descend_decision_dec != None:
            g_template, mapping, recurse_pass_flag = recurse_descend(
                descend_decision_dec, g, g_template, mapping, depth
            )
        else:
            g_template, mapping, recurse_pass_flag = recurse_ascend(
    ...
    while 1:
        ...
        if len(dec_list) != 0:
            ...
            for x in dec_list[2]:
                ...
                g_descended, mapping_descended = run_replace(
...
def import_dcp(file_name):
    ...
    os.system(
        "vivado -mode batch -notrace -source record_core.tcl -tclarg "
        + dcp
        + " 1 -stack 2000"
    )
